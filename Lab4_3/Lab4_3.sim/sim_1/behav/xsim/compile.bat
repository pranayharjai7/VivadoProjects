...
REM
REM Generated by Vivado on Fri Oct 15 02:57:45 +0200 2021
...
echo "xvlog --incr --relax -prj Lab4_3_partA_tb_vlog.prj"
call xvlog  --incr --relax -prj Lab4_3_partA_tb_vlog.prj -log xvlog.log
