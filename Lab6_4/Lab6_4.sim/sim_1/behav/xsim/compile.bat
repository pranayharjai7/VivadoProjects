...
REM
REM Generated by Vivado on Fri Nov 12 15:12:36 +0100 2021
...
echo "xvlog --incr --relax -prj calc_ones_function_tb_vlog.prj"
call xvlog  --incr --relax -prj calc_ones_function_tb_vlog.prj -log xvlog.log
