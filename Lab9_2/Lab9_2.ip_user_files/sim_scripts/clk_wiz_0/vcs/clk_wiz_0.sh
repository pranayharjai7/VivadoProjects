...
#
# Generated by Vivado on Fri Dec 10 01:24:11 +0100 2021
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2021.1.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../Lab9_2.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../Lab9_2.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
