...
REM
REM Generated by Vivado on Fri Nov 19 13:32:08 +0100 2021
...
echo "xvlog --incr --relax -prj Lab6_5verilog_tb_vlog.prj"
call xvlog  --incr --relax -prj Lab6_5verilog_tb_vlog.prj -log xvlog.log
