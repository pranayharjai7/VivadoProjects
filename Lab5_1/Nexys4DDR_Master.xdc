...
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {eq}]
set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports {gt}]
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports {lt}]
