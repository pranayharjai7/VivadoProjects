...
REM
REM Generated by Vivado on Fri Nov 19 14:56:01 +0100 2021
...
echo "xvlog --incr --relax -prj Lab7_2verilog_tb_vlog.prj"
call xvlog  --incr --relax -prj Lab7_2verilog_tb_vlog.prj -log xvlog.log
